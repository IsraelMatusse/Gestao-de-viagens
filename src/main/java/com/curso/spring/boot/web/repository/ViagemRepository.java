...
public interface ViagemRepository extends CrudRepository<ViagemModel, String>{
	...
	ViagemModel findBycodviagem(Long cod_viagem);
	 ...
	 @Query(value="select viagem.chaveviagem, viajante.nome, viagem.destino_viagem from viagem join viagem_viajante on viagem.codviagem=viagem_fk join viajante on viajante_fk=viajante.codigo where chaveviagem like %:chaveviagem%", nativeQuery=true)
